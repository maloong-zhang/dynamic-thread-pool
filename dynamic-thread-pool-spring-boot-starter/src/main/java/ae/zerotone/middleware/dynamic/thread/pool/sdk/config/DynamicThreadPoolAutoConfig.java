...
import ae.zerotone.middleware.dynamic.thread.pool.sdk.domain.DynamicThreadPoolService;
...
import ae.zerotone.middleware.dynamic.thread.pool.sdk.registry.redis.RedisRegistry;
import ae.zerotone.middleware.dynamic.thread.pool.sdk.trigger.job.ThreadPoolDataReportJob;
import ae.zerotone.middleware.dynamic.thread.pool.sdk.trigger.listener.ThreadPoolConfigAdjustListener;
...
public class DynamicThreadPoolAutoConfig {
  ...
  public DynamicThreadPoolService dynamicThreadPollService(
    ...
    // 获取缓存数据，设置本地线程池配置; 防止曾经修改过，但是应用重启之后，又回到了原来的配置
    Set<String> threadPoolKeys = threadPoolExecutorMap.keySet();
    for (String threadPoolKey : threadPoolKeys) {
      ThreadPoolConfigEntity threadPoolConfigEntity =
          redissonClient
              .<ThreadPoolConfigEntity>getBucket(
